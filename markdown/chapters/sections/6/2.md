...
The model consists of a simple 10 x 10 x 3 (NX, NY, NZ) grid and is defined using the following [GRID](#__RefHeading___Toc38674_784232322) section keywords to define the grid geometry:
...
The rock property data required to complete the [GRID](#__RefHeading___Toc38674_784232322) section is as follows:
...
The above keywords define all the properties required for the [GRID](#__RefHeading___Toc38674_784232322) section for this type of grid geometry.
...
The data required to define this type of grid consists of the [SPECGRID](#__RefHeading___Toc45797_7190362561) keyword to define the dimensions of the grid, that is:
...
A portion of the coordinate line data defined by the [COORD](#__RefHeading___Toc45757_719036256) keyword from the Norne model is shown on the next page.
...
The final keyword to define an Irregular Corner-Point geometry grid is the [ZCORN](#__RefHeading___Toc45757_7190362561) keyword that defines the depths of the cell corners. A portion of the [ZCORN](#__RefHeading___Toc45757_7190362561) data from the Norne model is shown below.
...
The rock property data required to complete the [GRID](#__RefHeading___Toc38674_784232322) section is the same as for a Cartesian Regular grid, as defined in section [6.2.1](#6.2.1.Cartesian Regular Grid|outline)[ ](#6.2.1.Cartesian Regular Grid|outline)[Cartesian Regular Grids](#6.2.1.Cartesian Regular Grid|outline) and the data is defined using the same keywords.  The resulting Norne model showing the ternary solution variable is displayed in Figure 6.5.
...
Figure 6.7 is based on a 10 x 10 x 3 grid, where NX is the R dimensions, NY the THETA dimensions, and NZ the z dimensions on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. Thus, in order to fully define this radial grid the following [RUNSPEC](#__RefHeading___Toc55591_1778172979) and [GRID](#__RefHeading___Toc38674_784232322) section keywords are required:
...
The above keywords define all the properties required for the [RUNSPEC](#__RefHeading___Toc55591_1778172979) and [GRID](#__RefHeading___Toc38674_784232322) sections for this type of grid geometry.


| Note Radial grids are currently not fully implemented in OPM Flow as the completion of the circle in the THETA direction is not supported. For reference only, this feature is activated via the COMPLETE parameter on the [COORDSYS](#__RefHeading___Toc45759_719036256) keyword in the [GRID](#__RefHeading___Toc38674_784232322) section. |
| --- |
...
Spider Grids have been implemented as an alternative to Radial Grids. They convert standard radial geometry keywords in the grid section into an Irregular Corner-Point Grid, which can then be visualized in OPM ResInsight. The only difference is that in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section the [SPIDER](#__RefHeading___Toc439805_750232207) keyword is used instead of the [RADIAL](#__RefHeading___Toc51752_2905512151) keyword.
...
Again, Figure 6.10 is based on a 10 x 10 x 3 grid, where NX is the R dimensions, NY the THETA dimensions and NZ the z dimensions on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. The only difference between this example and the previous example for radial grids is that the [RADIAL](#__RefHeading___Toc51752_2905512151) keyword has been replaced by the [SPIDER](#__RefHeading___Toc439805_750232207) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section, all the other keywords are exactly the same.
...
| --- | --- | --- | --- |
| Active and Inactive cells | Defines if a cell in the model is active by setting the [ACTNUM](#__RefHeading___Toc4410_421927891) property for a cell to either one or inactive by setting the value to zero. Cells that are inactive in the model are ignored computationally and can act as barriers to flow.  Thus, a shale in a conventional reservoir is normally treated as non-reservoir and is made inactive either by setting the [ACTNUM](#__RefHeading___Toc4410_421927891), [PORO](#__RefHeading___Toc45797_719036256), or [NTG](#__RefHeading___Toc33334_784232322) to zero for the cells representing the shale. | [ACTNUM](#__RefHeading___Toc4410_421927891) |  |
| Porosity | Porosity is a measure of the space in a reservoir rock. It is defined as the fraction of the total bulk volume of the rock not occupied by solids, that is it is the fraction of the cell that is porous and contains the reservoir fluids. | [PORO](#__RefHeading___Toc45797_719036256) |  |
| Reservoir Quality | Reservoir quality of the cell in terms of the gross volume derived from the structural grid and the net volume available for fluid flow in the model is expressed as a fraction from zero to one. A zero values means the cell does not contribute to flow and therefore is made inactive. A value of one means the gross and net volumes are identical for the cell | [NTG](#__RefHeading___Toc33334_784232322) |  |
| Permeability | Permeability is a measure of the ease with which a fluid will flow through a porous medium. In numerical models permeability is dependent on the direction of flow, that is x, y, and z directions in Cartesian and Irregular Corner-Point Grids, and the radial, theta, and z directions in radial grids. There are various formulations for permeability, absolute permeability, effective permeability, gas permeability, liquid permeability, etc., and the values are saturation dependent. Thus, values entered should be consistent with the relative permeability entered in the [PROPS](#__RefHeading___Toc39329_784232322) section. Normally Kair (Sg=1.0) should be entered for the cell permeability and the values may or not be corrected for overburden or humidity drying effects. Correcting for liquid flow and saturation end points etc., is accomplished by the relative permeability curves. For example, if Kair (Sg=1.0) has been entered for the cell permeability when Krg (Sg=1-Swc) should be less than one. | [PERMX](#__RefHeading___Toc45791_719036256) [PERMY](#__RefHeading___Toc45793_719036256) [PERMZ](#__RefHeading___Toc45795_719036256) | [PERMR](#__RefHeading___Toc19328_3701168388) [PERMTHT](#__RefHeading___Toc114309_23127940) [PERMZ](#__RefHeading___Toc45795_719036256) |
...
Modifications to basic grid property data (porosity, permeability, etc.) can only be done in the [GRID](#__RefHeading___Toc38674_784232322) section, thereafter only the calculated pore volumes and transmissibilities are available for adjustment in the [EDIT](#__RefHeading___Toc40641_784232322) section. Some engineers use the [GRID](#__RefHeading___Toc38674_784232322) section for the basic model formulation, and the [EDIT](#__RefHeading___Toc40641_784232322) section to document the changes to the “base” model using the [PORV](#__RefHeading___Toc96547_718313858), [TRANX](#__RefHeading___Toc93085_718313858), [TRANY](#__RefHeading___Toc93087_718313858), [TRANZ](#__RefHeading___Toc93089_718313858), etc. keywords.
