...
$$
q = (0.001127) (2π) \frac{\mathit{kh}}{μ}\left[\frac{{p}_{e} - {p}_{w}}{\left(ln \left(\frac{{r}_{e}}{{r}_{w}}\right) + S\right)}\right]
$$ {#eq-12-1}
...
$$
{q}_{o} = (0.001127) (2π) \frac{{\mathit{kk}}_{\mathit{ro}} h}{{B}_{o} {μ}_{o}}\left[\frac{{p}_{e} - {p}_{w}}{\left(ln \left(\frac{{r}_{e}}{{r}_{w}}\right) + S\right)}\right]
$$ {#eq-12-2}
...
$$
{r}_{b} = 0.28 \frac{{\left[\sqrt{\frac{{K}_{y}}{{K}_{x}}} \mathrm{Δ}{x}^{2} + \sqrt{\frac{{K}_{x}}{{K}_{y}}} \mathrm{Δ}{y}^{2}\right] }^{0.5}}{{\left(\frac{{K}_{y}}{{K}_{x}}\right)}^{0.25} + {\left(\frac{{K}_{x}}{{K}_{y}}\right)}^{0.25}}
$$ {#eq-12-3}
...
$$
{q}_{o} = \frac{(0.001127) (2π)}{\left(ln \left(\frac{{r}_{b}}{{r}_{w}}\right) + S\right)}\left(\frac{k{k}_{\mathit{ro}}h}{{B}_{o} {μ}_{o}} \left( {p}_{b} - {p}_{w} \right)\right)
$$ {#eq-12-4}
...
$$
{T}_{\mathit{xy}} = \frac{(0.001127) (2π)(\mathit{kh})}{\left(ln \left(\frac{{r}_{b}}{{r}_{w}}\right) + S\right)}
$$ {#eq-12-5}
...
$$
{M}_{o} = \left(\frac{{k}_{\mathit{ro}}}{{B}_{o} {μ}_{o}}\right)
$$ {#eq-12-6}
...
$$
{q}_{o} = {\sum }_{1}^{N}\left({T}_{\mathit{xy}} {M}_{o} \left({p}_{b} - {p}_{w}\right)\right)
$$ {#eq-12-7}
...
$$
{q}_{o} = PI\left( {p}_{e} - {p}_{w} \right)
$$ {#eq-12-8}
...
$$
PI = \frac{{q}_{o}}{\left( {p}_{e} - {p}_{w} \right)}
$$ {#eq-12-9}
...
$$
PI = \frac{{q}_{o}}{\left({p}_{b} - {p}_{w}\right)} = {\sum }_{1}^{N}\left({T}_{\mathit{xy}} {M}_{o} \right)
$$ {#eq-12-10}
...
$$
PI = {{\sum }_{n=1}^{N}\left({T}_{\mathit{xy}} {M}_{o} \left(\frac{ln \left(\frac{{r}_{b}}{{r}_{w}}\right) + S}{ln \left(\frac{{r}_{e}}{{r}_{w}}\right) + S}\right)\right)}_{n}
$$ {#eq-12-11}
...
$$
PI = {{\sum }_{n=1}^{N}\left({T}_{\mathit{xy}} {M}_{o} \right)}_{n}
$$ {#eq-12-12}
