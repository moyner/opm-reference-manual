...
Apart from the keywords that advance the simulator through time (the [DATES](#__RefHeading___Toc117621_2179381650), [TIME](#__RefHeading___Toc1252966_4250154414), and [TSTEP](#__RefHeading___Toc118323_1596574740) keywords),  the minimum required data is associated with defining a well ([WELSPECS](#__RefHeading___Toc268463_1366622701)), defining a well’s connection to the reservoir ([COMPDAT](#__RefHeading___Toc97651_3261743917)), and the operating and production targets and constraints for the well ([WCONHIST](#__RefHeading___Toc134880_2055188184),  [WCONPROD](#__RefHeading___Toc146754_4203985108), [WCONINJH](#__RefHeading___Toc146752_4203985108), or [WCONINJE](#__RefHeading___Toc146750_4203985108)).  Well connections can be “grouped” into completions using the [COMPLUMP](#__RefHeading___Toc97655_3261743917) keyword to represent actual physical well completions in the model. Wells can either operate independently or under group control. That is when a well is allocated to a group, then the group can dictate how the wells in the group under group control are operated. For example, a group may have production targets and constraints and all wells under group control within the group will be operated in such a manner as to satisfy the group’s targets and constraints. Note that wells can belong to a group but do not necessary have to be under group control. The top level group, level one, has the name FIELD and under this level can be wells, groups, and sub groups to the higher level groups. By default three group levels are defined that sets the wells as level three, reporting directly to defined groups at level two, and the level two groups reporting to the FIELD group at level one.  If a different configuration is required, then the [GRUPTREE](#__RefHeading___Toc118321_1596574740) keyword should be used to define the group hierarchy by defining a lower level group that reports directly to a higher level group.

The major well specification keywords are summarized in Table 12.1 for ease of reference.


| Major Well Specification Keywords |  |  |
| --- | --- | --- |
| Purpose | Keywords | Description |
| Vertical Flow Tubing Performance Table Specification | [VFPINJ](#__RefHeading___Toc121917_2556401936) | [VFPINJ – Define Injection Vertical Flow Performance Tables](#11.3.51.VFPINJ – Define Injection Vertical Flow Performance Tables\|outline). [VFPINJ](#__RefHeading___Toc121917_2556401936) declares similar data to [VFPPROD](#__RefHeading___Toc121919_2556401936) but for injection wells. |
| [VFPPROD](#__RefHeading___Toc121919_2556401936) | [VFPPROD – Define Production Vertical Flow Performance Tables](#11.3.52.VFPPROD – Define Production Vertical Flow Performance Tables\|outline). The [VFPPROD](#__RefHeading___Toc121919_2556401936) keyword defines production Vertical Flow Performance (“VFP”) tables that are used to determine the outflow or downstream pressure based on the inlet or upstream pressure and the phases flowing through the system.  For a well this means the table relates the flowing bottom-hole pressure (“FBHP”) to the well’s tubing head pressure (“THP”) based on the oil, gas, and water rates (and any artificial lift quantities like gas lift gas), or phases ratios, flowing up the wellbore. |  |
| Well Specification ‍ | [WELSPECS](#__RefHeading___Toc268463_1366622701) | [WELSPECS – Define Well Specifications](#11.3.65.WELSPECS – Define Well Specifications\|outline). The [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword defines the general well specification data for all well types, and must be used for all wells before any other well specification keywords are used in the input file. The keyword declares the name of the well, the initial group the well belongs to, the wellhead location and other key parameters. |
| Well Completion Data ‍ ‍ | [COMPDAT](#__RefHeading___Toc97651_3261743917) | [COMPDAT – Define Well Connections to the Grid](#11.3.3.COMPDAT – Define Well Connections to the Grid\|outline). [COMPDAT](#__RefHeading___Toc97651_3261743917) defines how a well is connected to the reservoir by defining or modifying existing well connections. |
| [COMPLUMP](#__RefHeading___Toc97655_3261743917) | [COMPLUMP – Assign Well Connections to Completions](#11.3.5.COMPLUMP – Assign Well Connections to Completions\|outline). The [COMPLUMP](#__RefHeading___Toc97655_3261743917) keyword assigns connections, as defined by the [COMPDAT](#__RefHeading___Toc97651_3261743917) keyword, to completion intervals. This “lumping” or “grouping” of the connections to various completion intervals allows automatic workovers and economic criteria to be applied to the completions (that is a set of connections) as opposed to the individual connections. |  |
| [COMPTRAJ](#__RefHeading___Toc97651_32617439171) | [COMPTRAJ – Define Well Trajectory Connections to the Grid](#12.3.38.COMPTRAJ – Define Well Trajectory Connections to the Grid\|outline). [COMPTRAJ](#__RefHeading___Toc97651_32617439171) keyword defines how a well that has been declared as a trajectory well, using the [WELTRAJ](#__RefHeading___Toc268463_13666227011) keyword, is connected to the reservoir model by defining or modifying existing well perforation depths. The keyword can only be used for wells defined by the [WELTRAJ](#__RefHeading___Toc268463_13666227011) keyword, This is an OPM Flow specific keyword and will therefore cause an error in the commercial simulator. |  |
| [WELTRAJ](#__RefHeading___Toc268463_13666227011) | [WELTRAJ – Define Well Trajectory Data](#12.3.285.WELTRAJ – Define Well Trajectory Data\|outline). [WELTRAJ](#__RefHeading___Toc268463_13666227011) defines a trajectory well together with the well trajectory data, and is used in conjunction with the [COMPTRAJ](#__RefHeading___Toc97651_32617439171) keyword to define the well connections to the simulation grid blocks. The keyword can only be used for trajectory wells that employ the [COMPTRAJ](#__RefHeading___Toc97651_32617439171) keyword to define the connections to the grid, This is an OPM Flow specific keyword and will therefore cause an error in the commercial simulator. |  |
| Historical Production and Injection Data | [WCONHIST](#__RefHeading___Toc134880_2055188184) | [WCONHIST – Define Well Historical Production Rates and Pressures](#11.3.53.WCONHIST – Define Well Historical Production Rates and Pressures\|outline). [WCONHIST](#__RefHeading___Toc134880_2055188184) defines production rates and pressures for wells that have been declared history matching wells by the use of this keyword. History matching wells are handled differently than ordinary wells that use the [WCONPROD](#__RefHeading___Toc146754_4203985108) keyword for controlling their production targets and constraints. |
| [WCONINJH](#__RefHeading___Toc146752_4203985108) | [WCONINJH – Well Historical Observed Injection Rates and Pressures](#11.3.56.WCONINJH – Well Historical Observed Injection Rates and Pressures\|outline). [WCONINJH](#__RefHeading___Toc146752_4203985108) declares similar data as the [WCONHIST](#__RefHeading___Toc134880_2055188184) keyword but for injection wells. |  |
| Predictive Production and Injection Data | [WCONPROD](#__RefHeading___Toc146754_4203985108) | [WCONPROD – Define Well Production Targets and Constraints](#11.3.57.WCONPROD – Define Well Production Targets and Constraints\|outline). The [WCONPROD](#__RefHeading___Toc146754_4203985108) keyword defines production targets and constraints for wells that have previously been defined by the [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword. |
| [WCONINJE](#__RefHeading___Toc146750_4203985108) | [WCONINJE – Well Injection Targets and Constraints](#11.3.55.WCONINJE – Well Injection Targets and Constraints\|outline). [WCONINJE](#__RefHeading___Toc146750_4203985108) declares similar data as the [WCONPROD](#__RefHeading___Toc146754_4203985108) keyword but for injection wells. |  |
| Well Control | [WELCNTL](#__RefHeading___Toc134886_2055188184) | [WELCNTL – Modify Well Control and Targets](#11.3.62.WELCNTL – Modify Well Control and Targets\|outline). The [WELCNTL](#__RefHeading___Toc134886_2055188184) keyword modifies a well’s target control and value, both rates and pressures, for previously defined wells without having to define all the variables on the well control keywords: [WCONPROD](#__RefHeading___Toc146754_4203985108), [WCONHIST](#__RefHeading___Toc134880_2055188184), [WCONINJE](#__RefHeading___Toc146750_4203985108), or [WCONINJH](#__RefHeading___Toc146752_4203985108) keywords. See also the [WELTARG](#__RefHeading___Toc134888_2055188184) keyword below. |
| [WECON](#__RefHeading___Toc134884_2055188184) | [WECON – Well Economic Criteria for Production Wells](#11.3.60.WECON – Well Economic Criteria for Production Wells\|outline). [WECON](#__RefHeading___Toc134884_2055188184) defines the economic criteria for production wells that have previously been defined by the [WELSPECS](#__RefHeading___Toc268463_1366622701) and [WCONPROD](#__RefHeading___Toc146754_4203985108) keywords. |  |
| [WEFAC](#__RefHeading___Toc48856_327352552) | [WEFAC – Define Well Efficiency](#10.2.11.WEFAC – Define Well Efficiency\|outline). [WEFAC](#__RefHeading___Toc48856_327352552) defines a well’s efficiency or up-time factor as opposed to setting the efficiency factors at the group level. |  |
| [WHISTCTL](#__RefHeading___Toc268465_1366622701) | [WHISTCTL - Define Well Historical Target Phase](#11.3.69.WHISTCTL - Define Well Historical Target Phase\|outline). The [WHISTCTL](#__RefHeading___Toc268465_1366622701) keyword changes the target control phase for wells declared as history match wells via the [WCONHIST](#__RefHeading___Toc134880_2055188184) keyword. The target phase is set on the [WCONHIST](#__RefHeading___Toc134880_2055188184) keyword and [WHISTCTL](#__RefHeading___Toc268465_1366622701) overrides this value for all subsequent entries on the [WCONHIST](#__RefHeading___Toc134880_2055188184) keyword. |  |
| [WELOPEN](#__RefHeading___Toc268461_1366622701) | [WELOPEN – Define Well and Well Connections Flowing Status](#11.3.63.WELOPEN – Define Well and Well Connections Flowing Status\|outline). [WELOPEN](#__RefHeading___Toc268461_1366622701) defines the status of wells and the well connections, and is used to open and shut previously defined wells and well connections without having to re-specify all the data on the well control keywords: [WCONPROD](#__RefHeading___Toc146754_4203985108),  [WCONHIST](#__RefHeading___Toc134880_2055188184), [WCONINJE](#__RefHeading___Toc146750_4203985108), or [WCONINJH](#__RefHeading___Toc146752_4203985108) keywords. |  |
| [WELTARG](#__RefHeading___Toc134888_2055188184) | [WELTARG – Modify Well Target and Constraint Values](#11.3.66.WELTARG – Modify Well Targets and Constraints Values\|outline). The [WELTARG](#__RefHeading___Toc134888_2055188184) keyword modifies the target and constraints values of both rates and pressures for previously defined wells without having to define all the variables on the well control keywords: [WCONPROD](#__RefHeading___Toc146754_4203985108),  [WCONHIST](#__RefHeading___Toc134880_2055188184), [WCONINJE](#__RefHeading___Toc146750_4203985108), or [WCONINJH](#__RefHeading___Toc146752_4203985108) keywords. See also the [WELCNTL](#__RefHeading___Toc134886_2055188184) keyword above. |  |
| Well Productivity Adjustments (Normally used in History Matching) | [WELPI](#__RefHeading___Toc121389_332691817) | [WELPI – Define Well Productivity and Injectivity Indices](#12.3.71.WELPI – Define Well Productivity and Injectivity Indices\|outline). [WELPI](#__RefHeading___Toc121389_332691817) is used to define a well’s productivity or injectivity index and the values entered on this keyword for a given well will override any previously calculated values, or values previously entered using this keyword. |
| [WPIMULT](#__RefHeading___Toc121645_2412586160) | [WPIMULT – Define Well Connection Multipliers](#11.3.74.WPIMULT – Define Well Connection Multipliers\|outline). The [WPIMULT](#__RefHeading___Toc121645_2412586160) keyword defines a well connection multiplier factor that scales the existing well connection values. The resulting effect is to scale the well’s productivity at the reporting time step the keyword is entered. |  |
| Notes: |  |  |

*Table 12.1: Major Well Specification Keywords*


Wells are initially allocated to groups via the [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword and groups have a similar set of keywords as for wells, as outlined in Table 12.2. However only a limited set of keywords have been implemented in OPM Flow compared with the commercial simulator’s set of keywords.


| Major Group Specification Keywords |  |  |
| --- | --- | --- |
| Purpose | Keywords | Description |
| Group Specification | [GRUPTREE](#__RefHeading___Toc118321_1596574740) | [GRUPTREE – Define Group Tree Hierarchy](#11.3.18.GRUPTREE – Define Group Tree Hierarchy\|outline). [GRUPTREE](#__RefHeading___Toc118321_1596574740) defines the hierarchy of groups that have been created by having wells assigned to them via the [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword. By default three group levels are defined that sets the wells as level three, reporting directly to defined groups at level two, and the level two groups reporting to the FIELD group at level one. |
| Predictive Production and Injection Data | [GCONPROD](#__RefHeading___Toc146746_4203985108) | [GCONPROD – Group Production Targets and Constraints](#11.3.13.GCONPROD – Group Production Targets and Constraints\|outline). The [GCONPROD](#__RefHeading___Toc146746_4203985108) keyword defines production targets and constraints for groups, including the top most group in the group hierarchy known as the FIELD group. |
| [GCONINJE](#__RefHeading___Toc134874_2055188184) | [GCONINJE – Group Injection Targets and Constraints](#11.3.12.GCONINJE – Group Injection Targets and Constraints\|outline). [GCONINJE](#__RefHeading___Toc134874_2055188184) declares similar data as for [GCONPROD](#__RefHeading___Toc146746_4203985108) but for group injection targets and constraints. |  |
| Group Control | [GECON](#__RefHeading___Toc134876_2055188184) | [GECON – Group Economic Criteria for Production Groups](#11.3.14.GECON – Group Economic Criteria for Production Groups\|outline). The [GECON](#__RefHeading___Toc134876_2055188184) keyword defines economic criteria for production groups, including the field level group FIELD, that have previously been defined by the [WELSPECS](#__RefHeading___Toc268463_1366622701) and [GCONPROD](#__RefHeading___Toc146746_4203985108) keyword. |
| [GEFAC](#__RefHeading___Toc268455_1366622701) | [GEFAC – Define Group Efficiency](#11.3.15.GEFAC – Define Group Efficiency\|outline). [GEFAC](#__RefHeading___Toc268455_1366622701) defines a group’s efficiency or up-time factor as opposed to setting the efficiency factors for individual wells. |  |
| [GRUPTARG](#__RefHeading___Toc196552_870710203) | [GRUPTARG – Modify Group Targets and Constraints Values](#12.3.103.GRUPTARG – Modify Group Targets and Constraints Values\|outline). [GRUPTARG](#__RefHeading___Toc196552_870710203) keyword modifies the production targets and constraints of both rates and pressures for previously defined groups without having to define all the variables on the group production control keywords: [GCONPROD](#__RefHeading___Toc146746_4203985108) or [GCONPRI](#__RefHeading___Toc659214_1190369742) keywords. |  |
| Notes: |  |  |

*Table 12.2: Major Group Specification Keywords*


The final set of keywords define various controls for the model, the keywords available to advance the simulator through time, and the available reporting keywords, as illustrated in Table 12.3.


| Schedule Advancement, Control, and Reporting Keywords |  |  |
| --- | --- | --- |
| Purpose | Keywords | Description |
| Control [RS](#__RefHeading___Toc137361_1317547213) and [RV](#__RefHeading___Toc137365_1317547213) Behavior | [DRSDT](#__RefHeading___Toc117623_2179381650) | [DRSDT – Solution Gas (Rs) Maximum Rate of Increase Parameters](#11.3.9.DRSDT – Solution Gas (Rs) Maximum Rate of Increase Parameters\|outline). [DRSDT](#__RefHeading___Toc117623_2179381650) defines the maximum rate at which the solution gas-oil ratio (Rs) can be increased in a grid cell. The keyword is similar in functionality to the [DRSDTR](#__RefHeading___Toc135414_4268459800) keyword, that defines the maximum rate at which Rs can be increased in a grid cell by region. |
| [DRSDTR](#__RefHeading___Toc135414_4268459800) | [DRSDTR – Solution Gas (Rs) Maximum Rate of Increase Parameters by Region](#12.3.17.DRSDTR – Solution Gas (Rs) Maximum Rate of Increase Parameters by Region\|outline). [DRSDTR](#__RefHeading___Toc135414_4268459800) defines the maximum rate at which the solution gas-oil ratio (Rs) can be increased in a grid cell for various regions in the model.  The keyword is similar in functionality to the [DRSDT](#__RefHeading___Toc117623_2179381650) keyword, that defines the maximum rate at which Rs can be increased in a grid cell for all cells in the model. |  |
| [DRVDT](#__RefHeading___Toc117625_2179381650) | [DRVDT – Solution Oil (Rv) Maximum Rate of Increase Parameters](#11.3.10.DRVDT – Solution Oil (Rv) Maximum Rate of Increase Parameters\|outline). [DRVDT](#__RefHeading___Toc117625_2179381650) defines the maximum rate at which the solution oil-gas ratio or condensate-gas ratio (Rv) can be increased in a grid cell. The keyword is similar in functionality to the [DRVDTR](#__RefHeading___Toc135416_4268459800) keyword, that defines the maximum rate at which Rv can be increased in a grid cell by region. |  |
| [DRVDTR](#__RefHeading___Toc135416_4268459800) | [DRVDTR – Solution Oil (Rv) Maximum Rate of Increase Parameters by Region](#12.3.19.DRVDTR – Solution Oil (Rv) Maximum Rate of Increase Parameters by Region\|outline). [DRVDTR](#__RefHeading___Toc135416_4268459800) defines the maximum rate at which the solution oil-gas ratio or condensate-gas ratio (Rv) can be increased in a grid cell for various regions in the model.  The keyword is similar in functionality to the [DRVDT](#__RefHeading___Toc117625_2179381650) keyword, that defines the maximum rate at which Rv can be increased in a grid cell for all cells in the model. |  |
| Schedule Advancement | [DATES](#__RefHeading___Toc117621_2179381650) | [DATES – Advance Simulation by Reporting Date](#11.3.8.DATES – Advance Simulation by Reporting Date\|outline). [DATES](#__RefHeading___Toc117621_2179381650) advances the simulation to a given report date after which additional keywords may be entered to instruct OPM Flow to perform additional functions via the [SCHEDULE](#__RefHeading___Toc43945_784232322) section keywords, or further [DATES](#__RefHeading___Toc117621_2179381650) keywords may be entered to advance the simulator to the next report date. |
| [TIME](#__RefHeading___Toc1252966_4250154414) | [TIME – Advance Simulation by Cumulative Reporting Time](#12.3.203.TIME – Advance Simulation by Cumulative Reporting Time\|outline). [TIME](#__RefHeading___Toc1252966_4250154414) advances the simulation to a given cumulative report time after which additional keywords may be entered to instruct OPM Flow to perform additional functions via the [SCHEDULE](#__RefHeading___Toc43945_784232322) section keywords, or further [TIME](#__RefHeading___Toc1252966_4250154414) keywords may be entered to advance the simulator to the next report time. |  |
| [TSTEP](#__RefHeading___Toc118323_1596574740) | [TSTEP – Advance Simulation by Reporting Time](#11.3.47.TSTEP – Advance Simulation by Reporting Time\|outline). [TSTEP](#__RefHeading___Toc118323_1596574740) keyword advances the simulation to a given report time after which additional keywords may be entered to instruct OPM Flow to perform additional functions via the [SCHEDULE](#__RefHeading___Toc43945_784232322) section keywords, or further [TSTEP](#__RefHeading___Toc118323_1596574740) keywords may be entered to advance the simulator to the next report time |  |
| Schedule Advancement Control | [TUNING](#__RefHeading___Toc146744_4203985108) | [TUNING - Numerical Tuning Control](#11.3.48.TUNING - Numerical Tuning Control\|outline). [TUNING](#__RefHeading___Toc146744_4203985108) defines the parameters used for controlling the commercial simulator’s numerical convergence parameters for the global grid. The keyword is mostly ignored by OPM Flow; however, the simulator can be instructed to read the [TUNING](#__RefHeading___Toc146744_4203985108) keyword if the appropriate command line parameter has been activated (see section [2.2 Running OPM Flow 2023-04 From The Command Line](#2.2.Running OPM Flow 2018-10 \|outline)). |
| [NEXTSTEP](#__RefHeading___Toc323446_1841740821) | [NEXTSTEP – Maximum Next Time Step Size ](#12.3.147.NEXTSTEP – Maximum Next Time Step Size \|outline). [NEXTSTEP](#__RefHeading___Toc323446_1841740821) defines the maximum time step size the simulator should take for the next time step. This keyword can be used to reset the time step for when known large changes to the model are taking place that may result in time step chops. |  |
| Reporting | [RPTSCHED](#__RefHeading___Toc268459_1366622701) | [RPTSCHED – Define SCHEDULE Section Reporting](#11.3.41.RPTSCHED – Define SCHEDULE Section Reporting\|outline). [RPTSCHED](#__RefHeading___Toc268459_1366622701) keyword defines the data in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section that is to be printed to the output print file in human readable format. |
| [RPTRST](#__RefHeading___Toc210154_2884651453) | [RPTRST – Define Data to be Written to the RESTART File](#9.2.11.RPTRST – Define Data to be Written to the RESTART File\|outline). [RPTRST](#__RefHeading___Toc210154_2884651453) keyword defines the data and frequency of the data to be written to the [RESTART](#__RefHeading___Toc135629_1317547213) file at each requested restart point. In addition to the solution data arrays required to restart a run, the user may request additional data to be written to the restart file for visualization in OPM ResInsight. |  |
| Notes: |  |  |

*Table 12.3: Schedule Advancement, Control, and Reporting Keywords*


In terms of structuring the format of the keywords in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section it is advisable to declared all the VLP tables, wells and groups at the start of [SCHEDULE](#__RefHeading___Toc43945_784232322) section as oppose to declaring the items as they are needed, or when they come on stream at various times during the simulation. This produces a cleaner input deck and tends to limit unforeseen errors, as all items are declared upfront and only the operational changes (opening wells, changing group and well targets, etc.) are needed. The example [SCHEDULE](#__RefHeading___Toc43945_784232322) section given on the following pages illustrates a typical [SCHEDULE](#__RefHeading___Toc43945_784232322) based on this philosophy.

The first segment of the example shows the start of the [SCHEDULE](#__RefHeading___Toc43945_784232322) section and the group definitions and controls. Here there are group controls only at the FIELD level and there are both production and injection rate targets, as well as water and liquid handling constraints applied on the FIELD level. These keywords are activated from the start of the simulation as set by the [START](#__RefHeading___Toc39156_327352552) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section, in this case January 1, 2020.
...
The next segment covers the well specification and includes the loading of the VFP tables via include files, declaring the wells using the [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword, and connecting the wells to the reservoir using the [COMPDAT](#__RefHeading___Toc97651_3261743917) keyword. In addition, the [COMPLUMP](#__RefHeading___Toc97655_3261743917) keyword is invoked to assign the well connections to  well completions.
...
Finally, the [WCONPROD](#__RefHeading___Toc146754_4203985108) keyword is used to define the operating conditions for the gas producers (GP01 and GP02) and to assign the VFP tables to the producing wells. Whereas the [WCONINJE](#__RefHeading___Toc146750_4203985108) keyword performs a similar function for the single gas injector, GI01.
...
The final part of the well specification segment is shown below and sets the well efficiency for the wells via the [WEFAC](#__RefHeading___Toc48856_327352552) keyword, the producing wells economic limits via the [WECON](#__RefHeading___Toc134884_2055188184) keyword,  and then advances the simulation to January 25, 2020. Thus, there is no production up to January 25, 2020 as all the wells are shut-in.
...
On January 25, 2020 yearly restarts are requested ([RPTRST](#__RefHeading___Toc210154_2884651453)) together with various printed reports ([RPTSCHED](#__RefHeading___Toc268459_1366622701)), as well as the maximum time step size of 31 days being set via the [TUNING](#__RefHeading___Toc146744_4203985108) keyword. More importantly, well GP01 is opened together with completion number one to put the well on production. Note that one needs to open both the well and the completion; hence, the two lines in the [WELOPEN](#__RefHeading___Toc268461_1366622701) keyword.
...
On February 1, 2020 further [SCHEDULE](#__RefHeading___Toc43945_784232322) keywords are processed.  The first keyword is the [RPTSCHED](#__RefHeading___Toc268459_1366622701) keyword that in this case switches off all reports printed to the *.PRT file, as only annual reports are required for this particular model.

Next the gas producer GP02 is put on production using two statements in the [WELOPEN](#__RefHeading___Toc268461_1366622701) keyword, and the simulator is requested to advance to report time step of March 1, 2020.
...
The [WCONINJH](#__RefHeading___Toc146752_4203985108) keyword has similar functionality as the [WCONHIST](#__RefHeading___Toc134880_2055188184) keyword, but is used for history matching injection wells instead.
...
From December 1, 2019 to January 1, 2020 the three oil producing wells will be under history matching control with the oil rate being the target rate for the wells. On January 1, 2020 the wells will be converted to normal producers as the [WELTARG](#__RefHeading___Toc134888_2055188184) keyword changes a well status from a history match well to a regular well.  At the same time the [WELTARG](#__RefHeading___Toc134888_2055188184) keyword sets all the wells to have their current FBHP as a constraint, by setting the target BHP values to the default values, which effectively makes the FBHP a target as it is now the “active” constraint.


The alternative keyword for implementing the same approach is the [WELCNTL](#__RefHeading___Toc134886_2055188184) keyword, but unfortunately this is currently not implemented in OPM Flow.
...
The connection term on the [COMPDAT](#__RefHeading___Toc97651_3261743917) keyword in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section, CONFACT, is simply the transmissibility portion of equation (12.4) for a given connection that is:
...
Equation (12.11) is used to calculate the PI for the well and is used to print the PI on the WELLS production report requested via the [RPTSCHED](#__RefHeading___Toc268459_1366622701) keyword in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section. Note that for gas wells with non-zero D-factors, the non-Darcy skin factor is added to to the skin (S) term in equation (12.11) in both the numerator and the denominator.  Secondly, re is often undetermined or unknown and it is common to default the DRADIUS parameter on the [WELSPECS](#__RefHeading___Toc268463_1366622701) keyword, in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section. If the well drainage radius (DRADIUS) is defaulted then equation (12.11) simplifies to:
