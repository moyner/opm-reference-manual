...
$$
{ρ}_{g} = \frac{m}{V} = \frac{P \mathit{MW}}{\mathit{ZRT}}
$$ {#eq-8-3}
...
$$
{c}_{g} = -\frac{1}{V} {\left(\frac{∂V}{∂P}\right)}_{T}
$$ {#eq-8-6}
...
$$
{γ}_{\mathit{API}} = \frac{141.5}{{γ}_{o}} - 131.5
$$ {#eq-8-13}
...
$$
{c}_{o} = - {\frac{1}{V} \left(\frac{∂V}{∂P}\right)}_{T}
$$ {#eq-8-15}
...
$$
{k}_{\mathit{rw}} ({S}_{w}) = {k}_{\mathit{rww}}{\left[\frac{{S}_{w} - {S}_{\mathit{wcr}}}{1 - {S}_{\mathit{orw}} - {S}_{\mathit{wcr}}}\right]}^{{n}_{w}}
$$ {#eq-8-20}
...
$$
{K}_{\mathit{row}} = \frac{{K}_{\mathit{rot}}{\left(1 - {S}_{wp}\right)}^{{L}_{o}}}{{\left(1 - {S}_{wp}\right)}^{{L}_{o}} + {E}_{o}{{S}_{wp}}^{{T}_{o}}}
$$ {#eq-8-21}


$$
{K}_{\mathit{rw}} = \frac{{K}_{\mathit{rwt}}{S}_{wp}^{{L}_{w}}}{{S}_{wp}^{{L}_{w}} + {E}_{w}{\left(1 - {S}_{wp}\right)}^{{T}_{w}}}
$$ {#eq-8-22}
...
$$
Y = \frac{{P}_{\mathit{cow}} - {P}_{\mathit{ct}}}{{P}_{\mathit{cir}} - {P}_{\mathit{ct}}} a\mathit{nd} Y = F\left({S}_{wp}\right) \mathit{where} {S}_{\mathit{wirr}}⩽{S}_{w}⩽1.0
$$ {#eq-8-24}
...
$$
F = \frac{{\left(1 - {S}_{wp}\right)}^{L}}{{\left(1 - {S}_{wp}\right)}^{L} + E{S}_{wp}^{T}} \text{and} {S}_{wp} = \frac{{S}_{w} - {S}_{\mathit{wirr}}}{1 - {S}_{\mathit{wirr}}}
$$ {#eq-8-26}
...
$$
{K}_{\mathit{row}} = \frac{{K}_{\mathit{rot}}{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{o}}}{{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{o}} + {E}_{o}{{S}_{\mathit{wn}}}^{{T}_{o}}}
$$ {#eq-8-27}


$$
{K}_{\mathit{rw}} = \frac{{K}_{\mathit{rwr}}{S}_{\mathit{wn}}^{{L}_{w}}}{{S}_{\mathit{wn}}^{{L}_{w}} + {E}_{w}{\left(1 - {S}_{\mathit{wn}}\right)}^{{T}_{w}}}
$$ {#eq-8-28}
...
$$
{G}_{n} = \frac{{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{\mathit{sn}}}}{{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{\mathit{sn}}} + {E}_{\mathit{sn}}{S}_{\mathit{wn}}^{{T}_{\mathit{sn}}}} {F}_{n} = \frac{{S}_{\mathit{wn}}^{{L}_{\mathit{fn}}}}{{S}_{\mathit{wn}}^{{L}_{\mathit{fn}}} + {E}_{\mathit{fn}}{\left(1 - {S}_{\mathit{wn}}\right)}^{{T}_{\mathit{fn}}}}
$$ {#eq-8-31}
...
$$
{K}_{\mathit{rog}} = \frac{{K}_{\mathit{rot}}{\left(1 - {S}_{\mathit{gn}}\right)}^{{L}_{o}}}{{\left(1 - {S}_{\mathit{gn}}\right)}^{{L}_{o}} + {E}_{o}{{S}_{\mathit{gn}}}^{{T}_{o}}}
$$ {#eq-8-33}


$$
{K}_{\mathit{rg}} = \frac{{K}_{\mathit{rgt}}{S}_{\mathit{gn}}^{{L}_{g}}}{{S}_{\mathit{gn}}^{{L}_{g}} + {E}_{g}{\left(1 - {S}_{\mathit{gn}}\right)}^{{T}_{g}}}
$$ {#eq-8-34}
...
$$
{G}_{n} = \frac{{\left(1 - {S}_{\mathit{gn}}\right)}^{{L}_{\mathit{sn}}}}{{\left(1 - {S}_{\mathit{gn}}\right)}^{{L}_{\mathit{sn}}} + {E}_{\mathit{sn}}{S}_{\mathit{gn}}^{{T}_{\mathit{sn}}}} {F}_{n} = \frac{{S}_{\mathit{gn}}^{{L}_{\mathit{fn}}}}{{S}_{\mathit{gn}}^{{L}_{\mathit{fn}}} + {E}_{\mathit{fn}}{\left(1 - {S}_{\mathit{gn}}\right)}^{{T}_{\mathit{fn}}}}
$$ {#eq-8-37}
...
$$
{K}_{\mathit{rgw}} = \frac{{K}_{\mathit{rgt}}{\left(1 - {S}_{wp}\right)}^{{L}_{g}}}{{\left(1 - {S}_{wp}\right)}^{{L}_{g}} + {E}_{g}{{S}_{wp}}^{{T}_{g}}}
$$ {#eq-8-39}
...
$$
Y = \frac{{P}_{\mathit{cgw}} - {P}_{\mathit{ct}}}{{P}_{\mathit{cir}} - {P}_{\mathit{ct}}} a\mathit{nd} Y = F\left({S}_{wp}\right) \mathit{where} {S}_{\mathit{wirr}}⩽{S}_{w}⩽1.0
$$ {#eq-8-42}
...
::: {.callout-note}
The SGWFLET keyword has not been implemented, as of this current release.
:::
...
$$
{K}_{\mathit{rgw}} = \frac{{K}_{\mathit{rgt}}{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{o}}}{{\left(1 - {S}_{\mathit{wn}}\right)}^{{L}_{o}} + {E}_{o}{{S}_{\mathit{wn}}}^{{T}_{o}}}
$$ {#eq-8-45}
