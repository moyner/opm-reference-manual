...
The [GRID](#kw-GRID) section defines the basic grid properties, including structure, faults, and various static rock properties (porosity, permeability, etc.).  The information in this section will be used by the software to calculate the pore volume ([PORV](#kw-PORV)) for each cell, the cell mid-point depths, and the regular transmissibilities ([TRANX](#kw-TRANX), [TRANY](#kw-TRANY), and [TRANZ](#kw-TRANZ)) between all the cells, as well as across faults. The OPM Flow calculated parameters can then be edited in the [EDIT](#kw-EDIT) section.
...
A brief introduction to the three types of grid and the data required to fully define the structural element of the grid together with the rock properties necessary to complete the [GRID](#kw-GRID) section data requirements is outlined in the following section. This is then followed by the keyword definitions applicable to this section.
