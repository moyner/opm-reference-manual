...
- Oil vaporization controls ([VAPPARS](#kw-VAPPARS)).
- Rock compaction.
...
- Well lists.
- Action conditions and command processing via the [ACTIONX](#kw-ACTIONX) and [UDQ](#kw-UDQ) keywords employed in the commercial simulator.
...
- Bi-conjugate Gradient method (BiCG-stab) and a restarted Generalized Minimal Residual ("GMRes") iterative linear solvers with ILU0 and Constraint Pressure Residual ("[CPR](#kw-CPR)") preconditioners.
