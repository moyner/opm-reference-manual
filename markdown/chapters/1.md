...
| $$ \frac{\partial }{\partial t}\left({ϕ}_{\mathit{ref}}{A}_{α}\right) + \nabla \overset{\dot}{ }\mathbf{{\text{u}}_{\mathrm{α}}} + {q}_{α} = 0 $$ | (1.1) |
| --- | --- |
...
| $$ {A}_{w}={m}_{ϕ}{b}_{w}{s}_{w} $$ | $$ \mathbf{{\text{u}}_{\mathrm{w}}}={b}_{w}\mathbf{{\text{v}}_{\mathrm{w}}} $$ | (1.2) |
| --- | --- | --- |
| $$ {A}_{o}={m}_{ϕ}\left({b}_{o}{s}_{o}+{r}_{\mathit{og}}{b}_{g}{s}_{g}\right) $$ | $$ \mathbf{{\text{u}}_{\mathrm{o}}}={b}_{o}\mathbf{{\text{v}}_{\mathrm{o}}}+{r}_{\mathit{og}}{b}_{g}\mathbf{{\text{v}}_{\mathrm{g}}} $$ | (1.3) |
| $$ {A}_{g}={m}_{ϕ}\left({b}_{g}{s}_{g}+{r}_{\mathit{go}}{b}_{o}{s}_{o}\right) $$ | $$ \mathbf{{\text{u}}_{\mathrm{g}}}={b}_{g}\mathbf{{\text{v}}_{\mathrm{g}}}+{r}_{\mathit{go}}{b}_{o}\mathbf{{\text{v}}_{\mathrm{o}}} $$ | (1.4) |


and the phase fluxes are given by Darcy's law:


| $$ \mathbf{{\text{v}}_{\mathrm{α}}} = -{λ}_{α}\mathbf{\text{K}}\left(\nabla {p}_{α} - {ρ}_{α}\mathbf{\text{g}}\right) $$ | (1.5) |
| --- | --- |
...
| --- | --- |
| $$  {p}_{c,\mathit{ow}} = {p}_{o} - {p}_{w} $$ | (1.7) |
| $$  {p}_{c,\mathit{og}} = {p}_{o} - {p}_{g} $$ | (1.8) |
...
$$
ϕ = {m}_{ϕ}\left({p}_{o}\right){ϕ}_{\mathit{ref}}
$$
...
$$
{b}_{α}={V}_{\mathit{surface};α} / {V}_{\mathit{reservoir};α}
$$
...
$$
{b}_{α}={b}_{α}\left({p}_{α},{r}_{\mathit{go}},{r}_{\mathit{og}}\right)
$$
...
$$
{p}_{c,αβ}={p}_{c,αβ}\left({S}_{α}\right)
$$
...
$$
{ρ}_{o}={b}_{o}\left({ρ}_{S,o}+{r}_{\mathit{go}}{ρ}_{S,g}\right)
$$

$$
{ρ}_{g}={b}_{g}\left({ρ}_{S,g}+{r}_{\mathit{og}}{ρ}_{S,o}\right)
$$
...
$$
{υ}_{o,\mathit{ij}}=-{υ}_{o,\mathit{ij}}
$$
...
| $$ {R}_{α,i}=\frac{{ϕ}_{\mathit{ref},i}{V}_{i}}{\mathrm{Δ}t}\left({A}_{α,i}-{{A}^{0}}_{α,i}\right) +\underset{jϵC(i)}{\sum }{u}_{α,\mathit{ij}}+{q}_{α,i}=0 $$ | (1.9) |
| --- | --- |
...
| $$ {A}_{w i}={\left({m}_{ϕ}{b}_{w}{s}_{w}\right)}_{i} $$ | $$ {u}_{w i}={\left({b}_{w}{υ}_{w}\right)}_{i} $$ | (1.10) |
| --- | --- | --- |
| $$ {A}_{o i}={\left({m}_{ϕ}\left({b}_{o}{s}_{o}+{r}_{\mathit{og}}{b}_{g}{s}_{g}\right)\right)}_{i} $$ | $$ {u}_{o i}={\left({b}_{o}{υ}_{o}+{r}_{\mathit{og}}{b}_{g}{υ}_{g}\right)}_{i} $$ | (1.11) |
| $$ {A}_{g i}={\left({m}_{ϕ}\left({b}_{g}{s}_{g}+{r}_{\mathit{go}}{b}_{o}{s}_{o}\right)\right)}_{i} $$ | $$ {u}_{g i}={\left({b}_{g}{υ}_{g}+{r}_{\mathit{go}}{b}_{o}{υ}_{o}\right)}_{i} $$ | (1.12) |


In addition, equations (1.6) to (1.8) also hold for each cell i, that is:


| $$ {\left( {s}_{w} + {s}_{o} + {s}_{g} \right)}_{i} = 1 $$ | (1.13) |
| --- | --- |
| $$  {\left( {p}_{c,\mathit{ow}} \right)}_{i} = {\left( {p}_{o} - {p}_{w} \right)}_{i} $$ | (1.14) |
| $$  {\left( {p}_{c,\mathit{og}} \right)}_{i} = {\left( {p}_{o} - {p}_{g} \right)}_{i}  $$ | (1.15) |
...
| $$  {\left({b}_{α}{υ}_{α}\right)}_{\mathit{ij}} = {\left({b}_{α}{λ}_{α}{m}_{T}\right)}_{{U}_{(α,\mathit{ij})}}{T}_{\mathit{ij}}\mathrm{Δ}{\mathrm{Φ}}_{α,\mathit{ij}} $$ | (1.16) |
| --- | --- |
| $$  {\left({r}_{βα}{b}_{α}{υ}_{α}\right)}_{\mathit{ij}} = {\left({r}_{βα}{b}_{α}{λ}_{α}{m}_{T}\right)}_{{U}_{(α,\mathit{ij})}}{T}_{\mathit{ij}}\mathrm{Δ}{\mathrm{Φ}}_{α,\mathit{ij}}  $$ | (1.17) |
| $$  \mathrm{Δ}{\mathrm{Φ}}_{α,\mathit{ij}} = {p}_{α,i}-{p}_{α,j}-g{ρ}_{α,\mathit{ij}}\left({z}_{i}-{z}_{j}\right) $$ | (1.18) |
| $$  {ρ}_{α,\mathit{ij}} = \frac{\left({ρ}_{α,i}+{ρ}_{α,j}\right)}{2} $$ | (1.19) |
| $$  U\left(α,\mathit{ij}\right) = \left{\begin{matrix}i, \mathrm{Δ}{\mathrm{Φ}}_{α,\mathit{ij}}\geq 0 \\ j, \mathrm{Δ}{\mathrm{Φ}}_{α,\mathit{ij}}\geq 0\end{matrix} $$ | (1.20) |
...
$$
\mathrm{Δ}{\mathrm{Φ}}_{(α,\mathit{ij})}
$$
...
For a grid containing a total of n active cells,  the material balance relationship expressed by equation (1.9) results in a system of 3n equations for the three phase formulation (oil, water, and gas). Similarly, for the two phase model, oil-water or gas-water, there are 2n equations to be solved.   In addition, there are also the sink and source terms associated with the wells. The solution variables for the system of equations is dependent on the state of a cell, basically, for:
    ...
    - Non-miscible: Here pressure of one of the phases (which we take to be oil pressure
...
$$
 ...
 as our primary variables. The pressure

$$
{p}_{o}
$$

 will then behave mostly in an elliptic fashion, whereas the saturations
...
are more hyperbolic.
    - Miscible flow: Since the gaseous phase may disappear if all the gas dissolves into the oleic phase, and similarly the oleic phase may disappear if all the oil vaporizes into the gaseous phase, one cannot always use

$$
{s}_{g}
$$

 for our third variable. Instead we use the third variable to track the composition of the phase that has not disappeared. We therefore use either
...
$$
 ...
 as our third primary variable, depending on the fluid state, and we call that variable x:
...
| $$ {Q}_{t} = \underset{α\in {o,g,w}}{\sum }{g}_{α}{Q}_{α}, {F}_{w} = \frac{{g}_{w}{Q}_{w}}{{Q}_{t}}, {F}_{g} = \frac{{g}_{g}{Q}_{g}}{{Q}_{t}} $$ | (1.22) |
| --- | --- |
...
| $$ {{q}^{r}}_{α,j}={T}_{w,j} {M}_{α,j}\left[{p}_{j}-({p}_{\mathit{bhp},w} + {h}_{w,j})\right] $$ | (1.23) |
| --- | --- |
...
| $$ {R}_{α,w}=\frac{{A}_{α,w}-{A}_{α,w}^{0}}{\mathrm{Δ}t} + {Q}_{α} - \underset{j\in C(w)}{\sum }{q}_{α,j} = 0 $$ | (1.24) |
| --- | --- |
...
| $$ {R}_{c,w} = {p}_{\mathit{bhp},w}-{p}_{\mathit{bhp},w}^{\mathit{target}} =0 $$ | (1.25) |
| --- | --- |
...
| $$ {R}_{c,w} ={Q}_{α} - {Q}_{α}^{\mathit{target}} = 0 $$ | (1.26) |
| --- | --- |
...
| $$ {R}_{α,n}=\frac{{A}_{α,n}-{A}_{α,n}^{0}}{\mathrm{Δ}t} + \underset{i\in I(n)}{\sum }{Q}_{α,i} - \underset{j\in C(w)}{\sum }{q}_{α,j} + {Q}_{α,n} = 0 $$ | (1.27) |
| --- | --- |
...
| $$ {{q}^{r}}_{α,j} = {T}_{w,j} {M}_{α,j}\left({p}_{j} + {H}_{c,j} - {p}_{n} - {H}_{\mathit{nc}}\right) $$ | (1.28) |
| --- | --- |
...
| $$ {R}_{p,n} = {p}_{n} - {p}_{m} - {H}_{h} - {H}_{f} - {H}_{a} = 0 $$ | (1.29) |
| --- | --- |
...
| $$ (A - \underset{w}{\sum }{C}_{w}{D}_{w}^{-1}{B}_{w}){x}_{r} = {R}_{r} - \underset{w}{\sum }{C}_{w}{{D}_{w}}^{-1}{R}_{w} $$ | (1.30) |
| --- | --- |
...
| $$ \frac{\partial }{\partial t}\left[ϕ\left({b}_{o}{s}_{o} + {r}_{\mathit{og}}{b}_{g}{s}_{g}\right)\right] + \nabla \overset{\dot}{ }\left({b}_{o}{ν}_{o} + {r}_{\mathit{og}}{b}_{g}{ν}_{g}\right) + {q}_{o} = 0 $$ | (1.31) |
| --- | --- |
...
| $$ \frac{\partial }{\partial t}\left[ϕ\left({b}_{g}{s}_{g} + {r}_{\mathit{go}}{b}_{o}{s}_{o}\right)\right] + \nabla \overset{\dot}{ }\left({b}_{g}{ν}_{g} + {r}_{\mathit{go}}{b}_{o}{ν}_{o}\right) + {q}_{g} = 0 $$ | (1.32) |
| --- | --- |
...
| $$ \frac{\partial }{\partial t}\left[ϕ\left({b}_{w}{s}_{w} + {r}_{\mathit{wg}}{b}_{g}{s}_{g}\right)\right] + \nabla \overset{\dot}{ }\left({b}_{w}{ν}_{w} + {r}_{\mathit{wg}}{b}_{g}{ν}_{g}\right) + {q}_{w} = 0 $$ | (1.33) |
| --- | --- |
...
| $$ \frac{\partial }{\partial t}\left[ϕ{b}_{w}{s}_{w}{c}_{w}^{\mathit{salt}} + {m}_{ϕ}{ϕ}_{0}{s}_{s}{ρ}^{\mathit{salt}}\right] + \nabla \overset{\dot}{ }\left({c}_{w}^{\mathit{salt}}{b}_{w}{ν}_{w}\right) + {c}_{w}^{\mathit{salt}}{q}_{w} = 0 $$ | (1.34) |
| --- | --- |
...
| $$ ϕ = \left(1 - {s}_{s}\right){m}_{ϕ}{ϕ}_{0} $$ | (1.35) |
| --- | --- |
...
| $$ J({y}_{n})\left({y}_{n+1} - {y}_{n}\right) = -R({y}_{n}) $$ | (1.36) |
| --- | --- |
...
$$
  ...
  - Secondly, since the third primary variable,

$$
x
$$

,may change solution state from one iteration to the next, this may disturb the convergence, and therefore a small threshold is applied (

$$
ε
$$

) to the variable-switching logic for equation (1.21), in order to prevent oscillation between states.
  - Thirdly, and frequently the main cause of non-convergence and the lack of smoothness of the residuals, is the discontinuity or inconsistent input data, particularly the relative permeability and capillary pressure functions.  Thus, using Corey [Corey,  A. T. : “The Interrelation Between gas and Oil Relative Permeabilities”, Production  Mon., 19. 38. (1954).] or Lomeland et al. [Lomeland F., 2018.Overview Of The Let Family Of Versatile Correlations For Flow Functions. Paper SCA2018-056 presented at the International Symposium of the Society of Core Analysts held in Trondheim, Norway, 27-30 August 2018.] type of curves for these data may well improve convergence performance, see Error: Reference source not found, Error: Reference source not found, and Error: Reference source not found, for OPM Flow’s implementation of the Lomeland type of curves.
...
For more information about run time options and numerical controls, see section Error: Reference source not found Error: Reference source not found on how to invoke various numerical schemes via the OPM Flow command line interface.
...
For more information about run time options and numerical controls, see section Error: Reference source not found Error: Reference source not found on how to invoke various numerical schemes via the OPM Flow command line interface. In addition, section Error: Reference source not found Error: Reference source not found provides some practical advice on how to address numerical performance issues.
...
| $$ {A}_{f}{l}_{c}\left(t\right)\left(1-{ϕ}_{c}\right)={f}_{s}{\int }_{0}^{t}q(τ)dτ={f}_{s}{Q}_{c}\left(t\right) $$ | (1.36) |
| --- | --- |
...
| $$ {l}_{c}\left(t\right)=\frac{{f}_{s}{Q}_{c}\left(t\right)}{{A}_{f}\left(1-{ϕ}_{c}\right)} $$  . | (1.36) |
| --- | --- |
...
| $$ \mathrm{\mathrm{Δ}}{P}_{d}\left(t\right)=\frac{qμ{f}_{s}{Q}_{c}\left(t\right)}{{{k}_{c}A}_{f}^{2}\left(1-{ϕ}_{c}\right)} $$ | (1.36) |
| --- | --- |
...
| $$ S=\frac{{f}_{s}}{1-{ϕ}_{c}}\frac{k}{{k}_{c}}\frac{{Q}_{c}\left(t\right)}{{A}_{f}{r}_{w}}=\frac{{l}_{c}}{{r}_{w}}\frac{k}{{k}_{c}} $$ | (1.36) |
| --- | --- |
...
| $$ π{r}_{w}^{2}-π{r}_{c}^{2}=\frac{{f}_{s}}{1-{ϕ}_{c}}{\int }_{0}^{t}{q}_{h}\left(t\right)dt=\frac{{f}_{s}}{1-{ϕ}_{c}}{Q}_{h}(t) $$ | (1.36) |
| --- | --- |
...
| $$ \mathrm{\mathrm{Δ}}{r}_{c}(t)={r}_{w}-{r}_{c}={r}_{w}-\sqrt{{r}_{w}^{2}-\frac{{f}_{s}{Q}_{h}\left(t\right)}{π(1-{ϕ}_{c})}} $$ | (1.36) |
| --- | --- |
...
| $$ \mathrm{\mathrm{Δ}}{P}_{c}=\frac{qμ}{2π{k}_{c}}\mathrm{ln}⁡\frac{{r}_{c}}{{r}_{w}} $$ | (1.36) |
| --- | --- |
...
| $$ S=\frac{k}{{k}_{c}}\mathrm{ln}⁡\frac{{r}_{w}}{{r}_{c}} $$ | (1.36) |
| --- | --- |
...
| $$ S=\frac{k}{{k}_{c}}\mathrm{ln}⁡\frac{{r}_{c}}{{r}_{w}} $$ | (1.36) |
| --- | --- |
...
| $$ {r}_{c}^{2}={r}_{w}^{2}+\frac{2{r}_{w}{f}_{s}Q\left(t\right)}{{A}_{f}(1-{ϕ}_{c})} $$ | (1.36) |
| --- | --- |
