...
$ϕ$	=	porosity, can be a function of (oil) pressure:$ϕ = {m}_{ϕ}\left({p}_{o}\right){ϕ}_{\mathit{ref}}$.
...
saturation:${p}_{c,αβ}={p}_{c,αβ}\left({S}_{α}\right)$.
...
phase the relationship is more complex since it must include dissolved gas: ${ρ}_{o}={b}_{o}\left({ρ}_{S,o}+{r}_{\mathit{go}}{ρ}_{S,g}\right)$, and similar for the gaseous phase we have:  ${ρ}_{g}={b}_{g}\left({ρ}_{S,g}+{r}_{\mathit{og}}{ρ}_{S,o}\right)$.
