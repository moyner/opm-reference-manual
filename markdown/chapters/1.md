...
$$
{R}_{α,i}=\frac{{ϕ}_{\mathit{ref},i}{V}_{i}}{\mathrm{Δ}t}\left({A}_{α,i}-{{A}^{0}}_{α,i}\right) +\underset{jϵC(i)}{\sum }{u}_{α,\mathit{ij}}+{q}_{α,i}=0
$$ {#eq-1-9}
...
$$
{{q}^{r}}_{α,j}={T}_{w,j} {M}_{α,j}\left[{p}_{j}-({p}_{\mathit{bhp},w} + {h}_{w,j})\right]
$$ {#eq-1-23}
...
$$
{{q}^{r}}_{α,j} = {T}_{w,j} {M}_{α,j}\left({p}_{j} + {H}_{c,j} - {p}_{n} - {H}_{\mathit{nc}}\right)
$$ {#eq-1-28}
...
$$
ϕ = \left(1 - {s}_{s}\right){m}_{ϕ}{ϕ}_{0}
$$ {#eq-1-35}
...
$$
{A}_{f}{l}_{c}\left(t\right)\left(1-{ϕ}_{c}\right)={f}_{s}{\int }_{0}^{t}q(τ)dτ={f}_{s}{Q}_{c}\left(t\right)
$$ {#eq-1-36}
...
$$
\mathrm{\mathrm{Δ}}{P}_{d}\left(t\right)=\frac{qμ{f}_{s}{Q}_{c}\left(t\right)}{{{k}_{c}A}_{f}^{2}\left(1-{ϕ}_{c}\right)}
$$ {#eq-1-36}
...
$$
S=\frac{{f}_{s}}{1-{ϕ}_{c}}\frac{k}{{k}_{c}}\frac{{Q}_{c}\left(t\right)}{{A}_{f}{r}_{w}}=\frac{{l}_{c}}{{r}_{w}}\frac{k}{{k}_{c}}
$$ {#eq-1-36}
...
$$
π{r}_{w}^{2}-π{r}_{c}^{2}=\frac{{f}_{s}}{1-{ϕ}_{c}}{\int }_{0}^{t}{q}_{h}\left(t\right)dt=\frac{{f}_{s}}{1-{ϕ}_{c}}{Q}_{h}(t)
$$ {#eq-1-36}
...
$$
\mathrm{\mathrm{Δ}}{r}_{c}(t)={r}_{w}-{r}_{c}={r}_{w}-\sqrt{{r}_{w}^{2}-\frac{{f}_{s}{Q}_{h}\left(t\right)}{π(1-{ϕ}_{c})}}
$$ {#eq-1-36}
...
$$
{r}_{c}^{2}={r}_{w}^{2}+\frac{2{r}_{w}{f}_{s}Q\left(t\right)}{{A}_{f}(1-{ϕ}_{c})}
$$ {#eq-1-36}
