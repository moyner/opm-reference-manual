...
| 5 | TYPE | A character string that defines the type of connections the diffusivity multiplier should be applied to, should be one of the following: | [ALL](#__RefHeading___Toc4420_421927891) |
