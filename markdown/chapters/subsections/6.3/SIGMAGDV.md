### SIGMAGDV – Dual Porosity Matrix to Fracture Sigma Gravity Drainage (Individual Cells)
...
Note that SIGMAGDV keyword data is used for areas being swept by gas and the [SIGMA](#__RefHeading___Toc695245_516898843) keyword data is used when the area is being invaded by water. See also the [SIGMAGD](#__RefHeading___Toc1228903_516898843) keyword in the [GRID](#__RefHeading___Toc38674_784232322) section that supplies a constant sigma value for all cells.
