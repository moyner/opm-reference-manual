...
The [MULTIREG](#__RefHeading___Toc296613_1576177388) keyword multiplies an array or part of an array by a constant for cells with a specific region number. The region number array can be [FLUXNUM](#__RefHeading___Toc45781_719036256), [MULTNUM](#__RefHeading___Toc61329_2752266063) or [OPERNUM](#__RefHeading___Toc67857_718313858) and these arrays must be defined and be available before the [MULTIREG](#__RefHeading___Toc296613_1576177388) keyword is read by the simulator. The constant can be an integer or real value depending on the array type; however, the arrays that can be operated on are dependent on which section the [MULTIREG](#__RefHeading___Toc296613_1576177388) keyword is being applied in.
...
*Table 6.71: [MULTIREG](#__RefHeading___Toc296613_1576177388) Keyword Applicable Arrays by Section*
...
The example first defines the [PORO](#__RefHeading___Toc45797_719036256) and [PERMX](#__RefHeading___Toc45791_719036256) property arrays for the model and then sets the [MULTNUM](#__RefHeading___Toc61329_2752266063) array to 1 for all cells in the model, after which selected areas of model are assigned various [MULTNUM](#__RefHeading___Toc61329_2752266063) integer values. The [MULTIREG](#__RefHeading___Toc296613_1576177388) can then be invoked to multiply the [PORO](#__RefHeading___Toc45797_719036256) and [PERMX](#__RefHeading___Toc45791_719036256) arrays by a constant for the various [MULTNUM](#__RefHeading___Toc61329_2752266063) regions.
