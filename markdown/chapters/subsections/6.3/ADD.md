...
The [ADD](#__RefHeading___Toc4412_421927891) keyword adds a constant to a specified array or part of an array. The constant can be an integer or real value depending on the array type; however, the arrays that can be operated on are dependent on which section the [ADD](#__RefHeading___Toc4412_421927891) keyword is being applied in.
...
| [ADD](#__RefHeading___Toc4412_421927891) Keyword and Variable Options by Section |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
...
*Table 6.4: [ADD](#__RefHeading___Toc4412_421927891) Keyword Applicable Arrays by Section*
...
The above example adds 20 md to the [PERMX](#__RefHeading___Toc45791_719036256) property array throughout the model.
