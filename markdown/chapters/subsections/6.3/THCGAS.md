...
| 1 | [THCGAS](#__RefHeading___Toc93091_718313858) | [THCGAS](#__RefHeading___Toc93091_718313858) is an array of real positive numbers that define the thermal conductivity of the gas phase in each grid block. Repeat counts may be used, for example 3000*20.0 | None |
...
Here, the [THCGAS](#__RefHeading___Toc93091_718313858) keyword is used in conjunction with the other thermal conductivity arrays to calculate the porosity weighted thermal conductivity of a grid block using:
...
See also the [THCOIL](#__RefHeading___Toc119871_650382403), and [THCWATER](#__RefHeading___Toc323954_1728001293), and [THCROCK](#__RefHeading___Toc124825_650382403) keywords in the [GRID](#__RefHeading___Toc38674_784232322) section. The commercial compositional simulator's THCSOLID keyword is not supported or required by OPM Flow.
...
The above example defines the gas phase thermal conductivity of 20.0 for each cell in the 300 grid block model as defined by the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.
