...
| 1 | [DRV](#__RefHeading___Toc91991_705534506) | [DRV](#__RefHeading___Toc91991_705534506) is a vector of real numbers describing the cell size for the grid blocks in the R direction in a radial grid. Repeat counts may be used, for example 10*100.0. | None |
| feet | m | cm |  |
| Notes: |  |  |  |
