### DZMATRIX – Matrix Block Height for Gravity Drainage Model For All Cells {#kw-DZMATRIX}
...
The keyword is identical to the [DZMTRXV](#kw-DZMTRXV) keyword in the [GRID](#kw-GRID) section.
