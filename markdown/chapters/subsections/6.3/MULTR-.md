...
| Notes: |  |  |  |
: MULTR- Keyword Description {#tbl-6-75}
...
See also the [MULTR](#kw-MULTR), [MULTTHT](#kw-MULTTHT), [MULTTHT-](#kw-MULTTHT-), [MULTZ](#kw-MULTZ) and [MULTZ-](#kw-MULTZ-) keywords for scaling transmissible between cells in the R direction.
