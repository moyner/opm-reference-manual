### JFUNC – Activate the Leverett J-function Option {#kw-JFUNC}
...
| Notes: |  |  |  |
: JFUNC Keyword Description {#tbl-6-53}
...
The above example results in the oil-water capillary pressure data entered on the [SWFN](#kw-SWFN) keyword in the [PROPS](#kw-PROPS) section being treated as J-Functions, and that the J-Function should be de-normalized using an oil-water surface density of 22.5 dynes/cm, using the default power values and the average of the [PERMX](#kw-PERMX) and [PERMY](#kw-PERMY) values for each grid block.