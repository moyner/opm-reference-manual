### SIGMA – Dual Porosity Matrix to Fracture Sigma (All Cells) {#kw-SIGMA}
...
See also the [SIGMAV](#kw-SIGMAV) keyword in the [GRID](#kw-GRID) section that supplies the sigma values on an individual cells basis.
