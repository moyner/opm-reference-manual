...
| 2 | CONSTANT | CONSTANT is a positive integer or positive real value that an ARRAY element will be reset to if an element in the defined input [BOX](#__RefHeading___Toc42110_3671211675), as defined by items (3) to (8), is greater than CONSTANT. CONSTANT has in the same units as the ARRAY property. | None |
...
| [MAXVALUE](#__RefHeading___Toc296601_1576177388) Keyword and Variable Options by Section |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
...
*Table 6.61: [MAXVALUE](#__RefHeading___Toc296601_1576177388) Keyword Applicable Arrays by Section*
...
The above example resets the maximum values for the [PERMX](#__RefHeading___Toc45791_719036256), [PERMY](#__RefHeading___Toc45793_719036256) and [PERMZ](#__RefHeading___Toc45795_719036256), arrays to 100.0, 100.0 and 10.0, respectively,  for all cells.
