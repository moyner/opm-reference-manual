...
The [ADDREG](#__RefHeading___Toc4414_421927891) keyword adds a constant to a specified array or part of an array based on cells with a specific region number. The region number array can be [FLUXNUM](#__RefHeading___Toc45781_719036256), [MULTNUM](#__RefHeading___Toc61329_2752266063) or [OPERNUM](#__RefHeading___Toc67857_718313858) and these arrays must be defined and be available before the [ADDREG](#__RefHeading___Toc4414_421927891) keyword is read by the simulator. The constant can be an integer or real value depending on the array type; however, the arrays that can be operated on are dependent on which section the [ADDREG](#__RefHeading___Toc4414_421927891) keyword is being applied in.
...
| [ADDREG](#__RefHeading___Toc4414_421927891) Keyword and Variable Options by Section |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
...
*Table 6.6: [ADDREG](#__RefHeading___Toc4414_421927891) Keyword Applicable Arrays by Section*
