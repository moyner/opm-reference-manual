...
| --- | --- | --- | --- |
| 1 | [MULTR](#__RefHeading___Toc228976_1841740821)+ | [MULTR](#__RefHeading___Toc228976_1841740821)+ is an array of real positive numbers assigning the transmissibility multipliers in the +R direction to each cell face in the model. Repeat counts may be used, for example 20*100.0. | 1.0 |
| Notes: |  |  |  |
