...
[PERMR](#__RefHeading___Toc19328_3701168388) sets the permeability for each cell in the R direction in a radial geometry grid. The [RADIAL](#__RefHeading___Toc51752_2905512151) or [SPIDER](#__RefHeading___Toc439805_750232207) keywords in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) should be activated to indicate that radial or spider geometry is being used.


| No. | Name | Description | Default |
| --- | --- | --- | --- |
| Field | Metric | Laboratory |  |
| 1 | [PERMR](#__RefHeading___Toc19328_3701168388) | [PERMR](#__RefHeading___Toc19328_3701168388) is an array of real positive numbers assigning the permeability in the R direction to each cell in the model. This equivalent to [PERMX](#__RefHeading___Toc45791_719036256) in a Cartesian grid. Repeat counts may be used, for example 20*100.0. | None |
| mD | mD | mD |  |
| Notes: |  |  |  |
...
See also the [PERMTHT](#__RefHeading___Toc114309_23127940) and [PERMZ](#__RefHeading___Toc45795_719036256) keywords to fully define the permeability for a radial or spider grid model.
...
The above example defines the [PERMR](#__RefHeading___Toc19328_3701168388) to be 500.0, 50.0, and 200.0 for the first, second and third layers in the model for all 300 cells, as defined by the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword (10, 10, 3) in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.
