### OLDTRANR – Activate Radial Regular Grid Transmissibilities {#kw-OLDTRANR}
...
This keyword switches on Radial Regular Grids geometry transmissibility calculation (or block centered transmissibility calculations), which is the default option for this type of grid. Grids defined by the [DR](#kw-DR), [DTHETA](#kw-DTHETA), and [DZ](#kw-DZ) series of keywords will always invoke this option by default.
