...
$$
\text{Average Thermal Conductivity}=\frac{\mathit{PORO}\times (\mathit{THCOIL}+\mathit{THCGAS}+\mathit{THCWATER}+\mathit{THCSOLID})}{\text{        NUMBER OF PHASES IN THE MODEL}}\times (1-\text{ PORO})\times \text{THCROCK}
$$ {#eq-6-20}
