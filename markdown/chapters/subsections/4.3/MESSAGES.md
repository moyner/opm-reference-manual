### MESSAGES – Define Message Print Limits and Stop Limits {#kw-MESSAGES}
...
The MESSAGES keyword defines the print and stops levels for various messages. The “print limits” set the maximum number of messages that will be printed, after which no more messages will be printed and the “stop limits” terminate the run when these limits are exceeded. There are six levels of message that increase in severity from informative all the way to programming errors, as outlined in @tbl-4-5.


| No. | Name | Description | Default |
| --- | --- | :------ | --- |
| 1 | PRTSMESG | An integer defining the maximum number of [MESSAGE](#kw-MESSAGE) type messages to be printed after which this type of message stops printing. | 1,000,000 |
...
| 7 | STOPMESG | An integer defining the maximum number of [MESSAGE](#kw-MESSAGE) type messages to be printed after which OPM Flow terminates the run. Not used by OPM Flow. | 1,000,000 |
...
| 13 | PRTGRPMS | An integer defining the maximum number of GROUP [MESSAGE](#kw-MESSAGE) type messages to be printed after which this type of message stops printing. Not used by OPM Flow. | 10 |
| Notes: |  |  |  |
: MESSAGES Keyword Description {#tbl-4-5}
#### Example
