### UNIFIN – Activate The Unified Input File Option {#kw-UNIFIN}
...
This keyword switches on the Unified Input Files option for all input files. Similar to the commercial simulator, OPM Flow has various options for reading various input files and writing the resulting OPM Flow  output files as described in @tbl-5-54.
...
| Notes: |  |  |  |
: UNIFIN Keyword Description {#tbl-5-54}
