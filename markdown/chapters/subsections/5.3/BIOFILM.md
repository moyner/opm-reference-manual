...
| Note This is an OPM Flow specific keyword used to investigate biofilm effects in underground applications. The module requires that either the CO2STORE or [H2STORE](#REF_HEADING_KEYWORD_H2STORE) keywords in the RUNSPEC to be active. |
| --- |
