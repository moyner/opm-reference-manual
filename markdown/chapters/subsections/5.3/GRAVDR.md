### GRAVDR – Activate Gravity Drainage and Imbibition for Dual Porosity Model {#kw-GRAVDR}
...
This keyword switches on gravity drainage and imbibition modeling between the matrix and the fracture grid blocks in dual porosity and dual permeability runs.  Note that either [DZMTRX](#kw-DZMTRX) or [DZMTRXV](#kw-DZMTRXV) keywords in the [GRID](#kw-GRID) section should be used to set the matrix vertical dimensions if this option is activated.
