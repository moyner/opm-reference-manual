### LGR – Define Local Grid Refinement Dimensions and Parameters {#kw-LGR}
...
| 6 | LSTACK | A positive integer that defines the maximum number of previous search directions stored by the linear solver for the LGR. See the [NSTACK](#kw-NSTACK) keyword in the [RUNSPEC](#kw-RUNSPEC) section for a full description. | 10 |
