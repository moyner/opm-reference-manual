...
| --- | --- | --- | --- |
| 1 | RSEED | RSEED is a positive integer greater than zero that sets a new random number seed for use in the [UDQ](#__RefHeading___Toc161095_2932703077) functions RANDN, RANDU RRNDN and RRNDU. See also the RSEED character variable on the [UDQDIMS](#__RefHeading___Toc65916_1778172979) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section to default the random number seed for a restart run. This feature is not supported by OPM Flow. | 1 |
