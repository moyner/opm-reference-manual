...
| $$ {\mathit{VE}}_{(\mathit{average})} = \left(1.0 - \mathrm{α}\right) \times  \left({\mathit{SATNUM}}_{\mathit{curves}}\right) + \mathrm{α} \times  \left(\mathit{VE}{\mathit{Model}}_{\mathit{curves}}\right) $$ | (8.95) |
| --- | --- |
