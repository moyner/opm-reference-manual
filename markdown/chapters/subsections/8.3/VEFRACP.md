### VEFRACP – Vertical Equilibrium Capillary Pressure Fraction (Grid) {#kw-VEFRACP}
...
Note that VEFRACP sets α for the whole grid; whereas, the [VEFRACPV](#kw-VEFRACPV) keyword in the [PROPS](#kw-PROPS) section assigns α on a cell by cell basis, See also the [VEFRAC](#kw-VEFRAC) and [VEFRACV](#kw-VEFRACV) keywords that apply the weighting factors to the relative permeability data.
