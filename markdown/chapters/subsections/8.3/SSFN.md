### SSFN – Solvent and Gas Relative Permeability Tables {#kw-SSFN}
...
| dimensionless | dimensionless | dimensionless |  |
| Notes: |  |  |  |
: SSFN Keyword Description {#tbl-8-172}
#### Example
...
The above example defines two SSFN tables for use with the [SOLVENT](#kw-SOLVENT) option.