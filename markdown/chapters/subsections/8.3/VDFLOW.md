### VDFLOW – Velocity Dependent Flow Coefficient for Grid Block Flow (Grid) {#kw-VDFLOW}
...
See also the [VDFLOWR](#kw-VDFLOWR) keyword in the [PROPS](#kw-PROPS) section that allows the non-Darcy coefficient to be entered for individual regions, and the [WDFAC](#kw-WDFAC) and [WDFACCOR](#kw-WDFACCOR) keywords in the [SCHEDULE](#kw-SCHEDULE) section that assigns the non-Darcy coefficient to well connections.
