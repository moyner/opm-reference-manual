### BOGI – Define Gi Oil Formation Volume Factor Pressure Tables {#kw-BOGI}
...
The BOGI keyword defines Gi oil formation volume factor as a function of Gi and pressure for when the Gi option has been invoked via the [GIMODEL](#kw-GIMODEL) keyword in the [RUNSPEC](#kw-RUNSPEC) section.
