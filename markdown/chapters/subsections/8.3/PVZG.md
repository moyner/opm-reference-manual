...
$\mathit{Psc}$	= pressure standard conditions (psia or kPa )

$\mathit{Pi}$	= initial reservoir pressure (psia or kPa)

$V$	= volume (ft3 or m3)

$T$	= absolute temperature (oR or K)

$\mathit{Tsc}$	= temperature at standard conditions (oR or K)

$\mathit{Ti}$	= initial reservoir temperature (oR or K)
