### VEFRAC – Vertical Equilibrium Relative Permeability Fraction (Grid) {#kw-VEFRAC}
...
Note that VEFRAC sets α for the whole grid; whereas, the [VEFRACV](#kw-VEFRACV) keyword in the [PROPS](#kw-PROPS) section assigns α on a cell by cell basis, See also the [VEFRACP](#kw-VEFRACP) and [VEFRACPV](#kw-VEFRACPV) keywords that apply the weighting factors to the capillary pressure data.
