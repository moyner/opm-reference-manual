### RPTPROPS – Define PROPS Section Reporting {#kw-RPTPROPS}
...
| --- | --- | :------ | --- |
| 1 | [PVDG](#kw-PVDG) | Print dry gas PVT tables | N/A |
| 2 | [PVTG](#kw-PVTG) | Print wet gas PVT tables | N/A |
| 3 | [SGFN](#kw-SGFN) | Print gas relative permeability saturation function tables. | N/A |
| 4 | [SGL](#kw-SGL) | Print connate gas saturation array. | N/A |
| …. |  | …. | N/A |
| Notes: |  |  |  |
: RPTPROPS Keyword Description {#tbl-8-132}
::: {.callout-note}
Except for tabular like data, [PVDG](#kw-PVDG) etc., this keyword has the potential to produce very large print files that some text editors may have difficulty loading. A more efficient solution for array type data is to load the *.[INIT](#kw-INIT) file into OPM ResInsight to view the data graphically, this also has the benefit of being able to filter the grid based on I, J, K ranges and grid properties.
:::
