### SSWCR – End-Point Scaling Grid Cell Critical Water Saturation
...
[SSWCR](#__RefHeading___Toc837495_4250154414) defines the surfactant critical water saturation for all the cells in the model via an array when the end-point scaling option has been invoked via the [ENDSCALE](#__RefHeading___Toc68146_2267116897) keyword and the surfactant phase has been activated by the [SURFACT](#__RefHeading___Toc863854_4250154414) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. The critical water saturation is defined as the maximum water saturation for which the water relative permeability is zero in a two-phase relative permeability table.  [SSWCR](#__RefHeading___Toc837495_4250154414) scales the surfactant water relative permeability data.
...
| 1 | [SSWCR](#__RefHeading___Toc837495_4250154414) | [SSWCR](#__RefHeading___Toc837495_4250154414) is an array of real numbers assigning the surfactant critical water saturation values to each cell in the model. The number of entries should correspond to the NX x NY x NZ parameters on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword. Repeat counts may be used, for example 30*0.20 | Taken from cell allocated relative permeability table. |
| dimensionless | dimensionless | dimensionless |  |
| Notes: |  |  |  |

*Table 8.177: SSWCR Keyword Description*
...
The above example defines a constant surfactant critical water saturation of 0.20 to all 300 cells in the model as defined by the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.
