### VEFRACV – Vertical Equilibrium Relative Permeability Fraction (Cell)
...
| $$ {\mathit{VE}}_{(\mathit{average})} = \left(1.0 - \mathrm{α}\right) \times  \left({\mathit{SATNUM}}_{\mathit{curves}}\right) + \mathrm{α} \times  \left(\mathit{VE}{\mathit{Model}}_{\mathit{curves}}\right) $$ | (8.97) |
| --- | --- |


Note that VEFRACVV sets α on a cell by cell basis; whereas, the VEFRAC keyword in the PROPS section assigns α for the whole grid, See also the VEFRACP and VEFRACPV keywords that apply the weighting factors to the capillary pressure data.
