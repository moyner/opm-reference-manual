### SSGL – End-Point Scaling Grid Cell Surfactant Connate Gas Saturations {#kw-SSGL}
...
The above example defines a constant surfactant connate gas saturation of 0.03 to all 300 cells in the model as defined by the [DIMENS](#kw-DIMENS) keyword in the [RUNSPEC](#kw-RUNSPEC) section.