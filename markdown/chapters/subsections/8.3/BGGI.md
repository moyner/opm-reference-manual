### BGGI – Define Gi Gas Formation Volume Factor Pressure Tables {#kw-BGGI}
...
The BGGI keyword defines Gi gas formation volume factor as a function of Gi and pressure for when the Gi option has been invoked via the [GIMODEL](#kw-GIMODEL) keyword in the [RUNSPEC](#kw-RUNSPEC) section.
...
See also the [PVTG](#kw-PVTG) and [GINODE](#kw-GINODE) keywords in the [PROPS](#kw-PROPS) section.