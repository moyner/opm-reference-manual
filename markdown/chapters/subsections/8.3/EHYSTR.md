### EHYSTR – Define Hysteresis Model and Parameters {#kw-EHYSTR}
...
| -1 | Equilibration option for equilibrating the model with the [SATNUM](#kw-SATNUM) (drainage curves) and running the model with imbibition curves ([IMBNUM](#kw-IMBNUM)). This option implies no hysteresis. |  |  |
| 0 | Carlson Hysteresis Model | [SATNUM](#kw-SATNUM) |  |
| 1 | Carlson Hysteresis Model | [IMBNUM](#kw-IMBNUM) |  |
| 2 | Killough Hysteresis Model | [SATNUM](#kw-SATNUM) |  |
| 3 | Killough Hysteresis Model | [IMBNUM](#kw-IMBNUM) |  |
| 4 | Killough Hysteresis Model | Killough Hysteresis Model |  |
| Oil Wet to Water Wet Water Wet |  |  |  |
| 5 | Carlson Non- Wetting Modeling for Gas and Water | [SATNUM](#kw-SATNUM) |  |
| 6 | Killough Non- Wetting Modeling for Gas and Water | [SATNUM](#kw-SATNUM) |  |
...
| Notes: |  |  |  |
: EHYSTR Keyword Description {#tbl-8-32}
#### Example
