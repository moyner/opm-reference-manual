...
See [EXTRAPMS – Activate Extrapolation Warning Messages](#3.1.6.EXTRAPMS – Activate Extrapolation Warning Messages|outline) in the GLOBAL section for a full description.
