...
[IKRWR](#__RefHeading___Toc70193_3358172231) defines the scaling parameter at the imbibition critical oil to water saturation value ([ISOWCR](#__RefHeading___Toc30436_7842323221)), for the imbibition water relative permeability curve, for all the cells in the model via an array.  The [ENDSCALE](#__RefHeading___Toc68146_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section should be activated to enable end-point scaling and the use of this keyword. In addition, the HYSTER option on the [SATOPTS](#__RefHeading___Toc37029_327352552) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section has to be activated to invoke the Hysteresis option. The SCALCERS keyword in the [PROPS](#__RefHeading___Toc39329_784232322) section defines the options used in the re-scaling process, the options are two point scaling and three point scaling.


| No. | Name | Description | Default |
| --- | --- | --- | --- |
| Field | Metric | Laboratory |  |
| 1 | [IKRWR](#__RefHeading___Toc70193_3358172231) | [IKRWR](#__RefHeading___Toc70193_3358172231) is an array of positive real numbers which are greater than zero and less than or equal to 1.0, that are the assigned imbibition scaling [IKRWR](#__RefHeading___Toc70193_3358172231) values for each cell in the model. Repeat counts may be used, for example 50*1.000. | Taken from cell allocated relative permeability table. |
...
When the [IKRWR](#__RefHeading___Toc70193_3358172231) keyword is present in the input deck then the scaling matches the imbibition relative permeability at the critical saturation of the displacing phase.
...
The first example defines an input box for the whole grid and for layers one to three, for layer one [IKRWR](#__RefHeading___Toc70193_3358172231) is set equal to 0.755, for layer two [IKRWR](#__RefHeading___Toc70193_3358172231) equals 0.775, and for layer three [IKRWR](#__RefHeading___Toc70193_3358172231) equals 0.800.
