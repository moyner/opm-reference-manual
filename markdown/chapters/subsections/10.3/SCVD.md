...
| 1 | DEPTH | A columnar vector of real monotonically increasing down the column   values that defines the depth values for the corresponding coal solvent concentration, SCVALS. | None |
| feet | m | cm |  |
| 2 | SCVALS | A columnar vector of real values that defines the coal solvent concentration values at the corresponding DEPTH. | None |
