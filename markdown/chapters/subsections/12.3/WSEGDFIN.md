### WSEGDFIN – Define Multi-Segment Well Drift Flux Slip Model Input Data {#kw-WSEGDFIN}
...
See also the WSEGFMD keyword in the [SCHEDULE](#kw-SCHEDULE) section that sets which type of slip model should be used.
