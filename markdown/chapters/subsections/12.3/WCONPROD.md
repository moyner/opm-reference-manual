...
| 12 | ALQ-WELL | A real positive value that defines the artificial lift quantity to be used in conjunction with the [VFPPROD](#__RefHeading___Toc121919_2556401936) assigned to the well via the VFPTAB variable. This value may be specified using a User Defined Argument (UDA). VFPTAB vertical lift performance table and the artificial lift quantity ALQ-WELL are used with the well fluid rates to calculate the well’s tubing head pressures values from the bottom-hole pressure. Note that the units for ALQ-WELL are dependent on the associated variable on the [VFPPROD](#__RefHeading___Toc121919_2556401936) keyword. | 0.0 |
