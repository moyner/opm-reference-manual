...
Here the [SWINGFAC](#__RefHeading___Toc1193036_4250154414) keyword sets the gas contract parameters for a single contract at the FIELD group level and is mutually exclusive to [GSWINGF](#__RefHeading___Toc224004_870710203) keyword in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section that allows for different gas contract parameters to be assign to different groups.
