...
This keyword defines a time interval for writing out the [SUMMARY](#kw-SUMMARY) data to the [SUMMARY](#kw-SUMMARY) file and the
      Atgeirr Rasmussen
...
See SUMTHIN – Define [SUMMARY](#kw-SUMMARY) Data Reporting Time Steps in the [SUMMARY](#kw-SUMMARY) section for a full description.