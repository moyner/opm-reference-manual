...
| psia | barsa | atma |  |
| 3 | MULTP | MULTP is a real positive or negative value that scales the tubing pressure loss by the following equation; Thus, a MULTP value greater then 1.0 increases the BHP and therefore makes a production well less productive; whereas, a value less than 1.0 increases the productivity of a production well.  Consequently, the opposite effect occurs for injection wells | 1.0 |
