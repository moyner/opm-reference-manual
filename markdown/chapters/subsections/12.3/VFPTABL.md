### VFPTABL – Define Production Vertical Flow Performance ALQ Interpolation {#kw-VFPTABL}
...
| Notes: |  |  |  |
: VFPTABL Keyword Description {#tbl-12-76}
#### Example

The example sets cubic spline interpolation for the ALQ quantity in the [VFPPROD](#kw-VFPPROD) tables, with linear interpolation used for all the variables.
