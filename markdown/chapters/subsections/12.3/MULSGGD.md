...
This keyword applies the multiplier for all cells in model; whereas, the MULSGGDV keyword in the SCHEDULE section applies the multiplier to individual grid blocks.
