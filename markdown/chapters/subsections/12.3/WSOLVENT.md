### WSOLVENT – Define Gas Injection Well Solvent Fraction {#kw-WSOLVENT}
...
WSOLVENT defines a gas injection well’s solvent fraction in the injection stream that is to be used when the Solvent option has been activated by the [SOLVENT](#kw-SOLVENT) keyword in the [RUNSPEC](#kw-RUNSPEC) section.
...
| Notes: |  |  |  |
: WSOLVENT Keyword Description {#tbl-12-124}
...
The following example defines the solvent fractions for three gas injection wells for when the solvent option has been activated by the [SOLVENT](#kw-SOLVENT) keyword in the [RUNSPEC](#kw-RUNSPEC) section.
