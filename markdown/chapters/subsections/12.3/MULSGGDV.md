### MULSGGDV – Multiply Matrix-Fracture Coupling for Oil-Gas Gravity Drainage for Individual Cells {#kw-MULSGGDV}
...
This keyword applies the multiplier for individual cells in model; whereas, the [MULSGGD](#kw-MULSGGD) keyword in the [SCHEDULE](#kw-SCHEDULE) section applies the multiplier to all grid blocks.
