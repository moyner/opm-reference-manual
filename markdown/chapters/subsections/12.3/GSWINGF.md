### GSWINGF – Define Group Multiple Gas Contract Parameters {#kw-GSWINGF}
...
Here the GSWINGF keyword allows for different gas contract parameters to be assign to different groups and is mutually exclusive to the [SWINGFAC](#kw-SWINGFAC) keyword in the [SCHEDULE](#kw-SCHEDULE) section, that sets the gas contract parameters for a single contract at the [FIELD](#kw-FIELD) group level.
