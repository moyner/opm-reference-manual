### WSURFACT – Define Water Injection Well Surfactant Concentration {#kw-WSURFACT}
...
WSURFACT defines a water injection well’s surfactant concentration in the injection stream that is to be used when the Surfactant phase has been activated by either the [SURFACT](#kw-SURFACT) or [SURFACTW](#kw-SURFACTW) keywords in the [RUNSPEC](#kw-RUNSPEC) section.
...
| Notes: |  |  |  |
: WSURFACT Keyword Description {#tbl-12-125}
...
The following example defines the surfactant concentrations for three water injection wells for when the surfactant phase option has been activated by either the [SURFACT](#kw-SURFACT) or [SURFACTW](#kw-SURFACTW) keywords in the [RUNSPEC](#kw-RUNSPEC) section.  Here the surfactant concentration has been set to 0.200 for all three wells.
